...
const (
	startASymbol byte = 103
	startBSymbol byte = 104
	startCSymbol byte = 105
)

const (
	codeASymbol byte = 101
	codeBSymbol byte = 100
	codeCSymbol byte = 99
)
...
const (
	abTable    = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_"
	bTable     = abTable + "`abcdefghijklmnopqrstuvwxyz{|}~\u007F"
	aOnlyTable = "\u0000\u0001\u0002\u0003\u0004" + // NUL, SOH, STX, ETX, EOT
		"\u0005\u0006\u0007\u0008\u0009" + // ENQ, ACK, BEL, BS,  HT
		"\u000A\u000B\u000C\u000D\u000E" + // LF,  VT,  FF,  CR,  SO
		"\u000F\u0010\u0011\u0012\u0013" + // SI,  DLE, DC1, DC2, DC3
		"\u0014\u0015\u0016\u0017\u0018" + // DC4, NAK, SYN, ETB, CAN
